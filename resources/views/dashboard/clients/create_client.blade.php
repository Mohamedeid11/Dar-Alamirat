                        ...
                        <div class="panel-body">
                            ...
                            <div class="row mb-15px">
                                ...
                                <div class="row mb-15px">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="birthday" type="text" class="form-control @error('birthday') is-invalid @enderror" name="birthday" pattern="\d{4}-\d{2}-\d{2}" placeholder="YYYY-MM-DD" value="{{ old('birthday') }}" required>
                                        @error('birthday')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
