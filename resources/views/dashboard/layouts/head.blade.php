<head>
    ...
    <link href="{{asset('admin-panel/assets/plugins/jquery-jvectormap/jquery-jvectormap-1.2.2.css')}}" rel="stylesheet" />
    <link href="{{asset('admin-panel/assets/plugins/bootstrap-calendar/css/bootstrap_calendar.css')}}" rel="stylesheet" />
    <link href="{{asset('admin-panel/assets/plugins/gritter/css/jquery.gritter.css')}}" rel="stylesheet" />
    <link href="{{asset('admin-panel/assets/plugins/morris/morris.css')}}" rel="stylesheet" />
